...
export type GetAnswersAggregateType<T extends AnswersAggregateArgs> = {
    [P in keyof T & keyof AggregateAnswers]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateAnswers[P]> : Prisma.GetScalarType<T[P], AggregateAnswers[P]>;
};
...
type GetAnswersGroupByPayload<T extends answersGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<AnswersGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof AnswersGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], AnswersGroupByOutputType[P]> : Prisma.GetScalarType<T[P], AnswersGroupByOutputType[P]>;
}>>;
export type answersWhereInput = {
    ...
    id?: Prisma.StringFilter<"answers"> | string;
};
...
export type answersScalarWhereWithAggregatesInput = {
    ...
    id?: Prisma.StringWithAggregatesFilter<"answers"> | string;
};
...
export type answersOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id", ExtArgs["result"]["answers"]>;
...
export type answersCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<answersFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface answersDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['answers'];
        meta: {
            name: 'answers';
        };
    };
     ...
     * })
     */
    findRaw(args?: Prisma.answersFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>;
    /**
     ...
     * })
     */
    aggregateRaw(args?: Prisma.answersAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>;
    /**
     ...
     * })
    **/
    count<T extends answersCountArgs>(args?: Prisma.Subset<T, answersCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], AnswersCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends answersGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, answersGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAnswersGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
 ...
 * answers findRaw
 */
export type answersFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
 ...
 */
export type answersAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
